          ...
          <div class="actions">
            <div class="follow-info">
              <h2>
                <a
                  href="#"
                ><span>{{ number }}</span><small>Número</small></a>
              </h2>
              <h2>
                <a
                  href="#"
                ><span>{{ type }}</span><small>Tipo</small></a>
              </h2>
            </div>
...
export default {
  computed: {
    ...mapState("pokeStore", ["pokemon", "number", "type", "description"]),
...
.card .banner {
  background-image: url("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/1.svg");
